package com.igortauh.crudpoo.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.igortauh.crudpoo.controllers"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "API REST da adaptação do trabalho",
                "",
                "1.0",
                "",
                new Contact("Igor Tauhan", "github.com/igortauh/crud_poo_trabalho", ""),
                "",
                "",
